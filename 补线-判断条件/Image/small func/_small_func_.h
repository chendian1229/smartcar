...
//void xiang_xia_hua_yan_shen_xian(uint8 img[][IMG_W_USED],uint8 gray_v,zb_imgarr_t I_1,zb_imgarr_t I_2);
...
/*斜率（m_xie_lv.c）*/
slope_t calcu_slope(zb_math_t M_1,zb_math_t M_2);//★输入的两点不能重合 否则此函数输出将无意义★
