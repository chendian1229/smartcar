...
void f__guaidian_X(uint8 img[][IMG_W_YS],uint8 *flg_l,zb_imgarr_t *gd_l,uint8 *flg_r,zb_imgarr_t *gd_r)
{
  ...
  *flg_r=0;
  ...
  I_last_l.i=79;
  I_last_r.i=79;
  f__edge_sp_czj(img[79],93,&nomeaning_tmp_l,&(I_last_l.j),&nomeaning_tmp_r,&(I_last_r.j));
  l_sdkd_last=93-I_last_l.j;
  r_sdkd_last=I_last_r.j-94;
  if(l_sdkd_last>85)
  {
    l_jxz_flg=0;
  }
  ...
  for( int16 Ci=78 ; Ci>=0 ; Ci=Ci-2 )
  {
    ...
    I_l.i=Ci;
    I_r.i=Ci;
    f__edge_sp_czj(img[Ci],93,&nomeaning_tmp_l,&(I_l.j),&nomeaning_tmp_r,&(I_r.j));
    l_sdkd=93-I_l.j;
    r_sdkd=I_r.j-94;
...
void gd_hua_zfx(uint8 img[][IMG_W_USED],uint8 gray_v,zb_imgarr_t I_zfx_mid)
{
  ...
  ShangZuo.i=I_zfx_mid.i-zfxkd;
  ShangZuo.j=I_zfx_mid.j-zfxkd;
  
  ShangYou.i=I_zfx_mid.i-zfxkd;
  ShangYou.j=I_zfx_mid.j+zfxkd;
  
  XiaYou.i=I_zfx_mid.i+zfxkd;
  XiaYou.j=I_zfx_mid.j+zfxkd;
  
  XiaZuo.i=I_zfx_mid.i+zfxkd;
  XiaZuo.j=I_zfx_mid.j-zfxkd;
